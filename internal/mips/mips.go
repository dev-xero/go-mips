...
//
// Due to language constraints, certain fields have been expanded to 8-bits
// from their original 6 or 5-bits in the MIPS spec.
...
func (cpu *CPU) parseInstruction(line string) Instruction {
